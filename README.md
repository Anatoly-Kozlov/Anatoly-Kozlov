...
- SQL (оконные функции, сложные запросы, CTE)
...
|---|-------------|----------|----------------------|--------|
| 1 | Power-BI | Дашборды и модели данных | Power BI, DAX, Power Query, DataLens | [![GitHub](https://img.shields.io/badge/GitHub-Посмотреть-181717?style=flat&logo=github)](https://github.com/Anatoly-Kozlov/Power-BI) |
